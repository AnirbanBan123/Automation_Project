# Automation_Project
This is the Automation project of DevOps C1 - DevOps Essentials
Problem Statement (Task 2)
Create a Bash script to update the package details and the package list at the start of the script.
